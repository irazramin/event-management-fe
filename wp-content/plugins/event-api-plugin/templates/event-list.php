<div>
    <div class="event-header">
        ...
        <div class="event-view-toggle">
            <button class="active toggle-button <?php echo esc_attr($atts['view']) === 'grid' ? 'active' : ''; ?>" data-view="grid">
                <i class="fas fa-th-large"></i>
            </button>
            <button class="toggle-button <?php echo esc_attr($atts['view']) === 'list' ? 'active' : ''; ?>" data-view="list">
                ...
                <div class="event-list__details">
                        <div class="event-list__info">
                            ...
                            <div class="event-list__wrapper">
                                <p class="event-list__category"> <i class="fas fa-tag"></i> <?php echo esc_html($event['category']); ?></p>
                                <p class="event-list__category"> <i class="fas fa-map-marker-alt"></i>  <?php echo esc_html($event['location']); ?></p>
                            </div>
                        </div>
                        <div class="event-list__actions">
                            <a href="<?php echo esc_url(add_query_arg('event_id', $event['id'], site_url('edit-event'))); ?>" class="event-list__edit-link"><i class="fas fa-pen"></i></a>
                            ...
                            <button type="button" class="event-list__delete-button delete-event-button" data-id="<?php echo esc_attr($event['id']); ?>"><i class="fas fa-trash"></i></button>
                        </div>
                </div>
                </div>
            <?php endforeach; ?>
